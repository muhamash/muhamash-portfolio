...
export default function AboutPage() {
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen w-full p-6 bg-black text-white overflow-hidden">
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl w-full px-6">
        <div>
        ...
        <div>
          <h2 className="text-2xl font-semibold text-white mb-3">Social Media Insights</h2>
