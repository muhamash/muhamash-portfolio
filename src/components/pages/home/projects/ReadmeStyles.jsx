...
const ReadmeOutput = ({
  ...
  return (
    <div className={cn("bg-gray-900 text-gray-100 p-6 rounded-lg shadow-lg font-mono text-sm leading-relaxed")}>
      ...
      {envVariables?.length > 0 && (
        <div className="mb-4">
          ...
          <pre className="bg-gray-800 p-2 rounded">{envVariables.join("\n")}</pre>
        </div>
      )}
