    ...
    >
      ...
      <div className="flex md:flex-row flex-col gap-10 items-center w-full md:justify-between z-50 md:p-10 pb-5">
        ...
        <div className="flex flex-col gap-3 w-full md:w-[500px] h-fit p-3">
          ...
          <p className="text-gray-300 font-mono text-md font-outfit">Email: muhammad-ashraful@outlook.com</p>
          <p className="text-gray-300 font-mono text-md font-outfit">Phone: +8801306567164</p>
