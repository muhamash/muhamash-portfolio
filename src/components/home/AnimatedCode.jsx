...
export default function CodeEditor() {
  ...
  return (
    <div className="relative p-6 md:w-[450px] w-[300px] bg-gray-800 rounded-lg shadow-md md:h-96 h-[300px] overflow-hidden source_code_pro_54d47b2a-module__pcAarq__className">
      <div
