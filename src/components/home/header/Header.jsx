...
export default async function HeaderComponent() {
    return (
        <div className="relative z-10 min-h-screen min-w-screen flex md:flex-row flex-col md:justify-between justify-center gap-10 items-center mx-auto py-10 mb-10">
